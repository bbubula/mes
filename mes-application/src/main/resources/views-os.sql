...
CREATE OR REPLACE VIEW public.masterorders_masterorderspositiondto AS SELECT (( SELECT COALESCE(max(masterorders_masterorderproduct.id), 0) AS "coalesce" FROM masterorders_masterorderproduct)) + row_number() OVER () AS id, masterorderdefinition.name, masterorder.id AS masterorderid, masterorder.product_id AS productid, masterorderproduct.id AS masterorderproductid, masterorder.masterordertype, masterorder.name AS masterordername, masterorder.number, masterorder.deadline, masterorder.masterorderstate AS masterorderstatus, masterorder.masterorderpositionstatus, masterorder.masterorderquantity, ( SELECT sum(orders.plannedquantity) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorder masterorder_1 ON orders.masterorder_id = masterorder_1.id WHERE masterorder_1.product_id = orders.product_id and orders.masterorder_id = masterorder.id) AS cumulatedmasterorderquantity, ( SELECT sum(orders.donequantity) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorder masterorder_1 ON orders.masterorder_id = masterorder_1.id WHERE masterorder_1.product_id = orders.product_id and orders.masterorder_id = masterorder.id) AS producedorderquantity, masterorder.comments, (masterorder.masterorderquantity - (SELECT COALESCE(sum(orders.donequantity),0) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorder masterorder_1 ON orders.masterorder_id = masterorder_1.id WHERE masterorder_1.product_id = orders.product_id and orders.masterorder_id = masterorder.id))AS lefttorelease, product.number AS productnumber, product.name AS productname, product.unit, technology.number AS technologyname, company.name AS companyname, masterorder.active FROM masterorders_masterorder masterorder LEFT JOIN masterorders_masterorderproduct masterorderproduct ON masterorder.id = masterorderproduct.masterorder_id LEFT JOIN masterorders_masterorderdefinition masterorderdefinition ON masterorder.masterorderdefinition_id = masterorderdefinition.id LEFT JOIN basic_product product ON masterorder.product_id = product.id LEFT JOIN basic_company company ON masterorder.company_id = company.id LEFT JOIN technologies_technology technology ON masterorder.technology_id = technology.id WHERE masterorder.masterordertype = '02oneProduct' and (SELECT COALESCE(sum(orders.donequantity),0) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorder masterorder_1 ON orders.masterorder_id = masterorder_1.id WHERE masterorder_1.product_id = orders.product_id and orders.masterorder_id = masterorder.id) < masterorder.masterorderquantity UNION ALL SELECT (( SELECT COALESCE(max(masterorders_masterorderproduct.id), 0) AS "coalesce" FROM masterorders_masterorderproduct)) + row_number() OVER () AS id, masterorderdefinition.name, masterorder.id AS masterorderid, masterorder.product_id AS productid, masterorderproduct.id AS masterorderproductid, masterorder.masterordertype, masterorder.name AS masterordername, masterorder.number, masterorder.deadline, masterorder.masterorderstate AS masterorderstatus, masterorder.masterorderpositionstatus, masterorder.masterorderquantity, ( SELECT sum(orders.plannedquantity) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorder masterorder_1 ON orders.masterorder_id = masterorder_1.id WHERE masterorder_1.product_id = orders.product_id and orders.masterorder_id = masterorder.id) AS cumulatedmasterorderquantity, ( SELECT sum(orders.donequantity) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorder masterorder_1 ON orders.masterorder_id = masterorder_1.id WHERE masterorder_1.product_id = orders.product_id and orders.masterorder_id = masterorder.id) AS producedorderquantity, masterorder.comments, 0 AS lefttorelease, product.number AS productnumber, product.name AS productname, product.unit, technology.number AS technologyname, company.name AS companyname, masterorder.active FROM masterorders_masterorder masterorder LEFT JOIN masterorders_masterorderproduct masterorderproduct ON masterorder.id = masterorderproduct.masterorder_id LEFT JOIN masterorders_masterorderdefinition masterorderdefinition ON masterorder.masterorderdefinition_id = masterorderdefinition.id LEFT JOIN basic_product product ON masterorder.product_id = product.id LEFT JOIN basic_company company ON masterorder.company_id = company.id LEFT JOIN technologies_technology technology ON masterorder.technology_id = technology.id WHERE masterorder.masterordertype = '02oneProduct' and (SELECT COALESCE(sum(orders.donequantity),0) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorder masterorder_1 ON orders.masterorder_id = masterorder_1.id WHERE masterorder_1.product_id = orders.product_id and orders.masterorder_id = masterorder.id) >= masterorder.masterorderquantity UNION ALL SELECT COALESCE(masterorderproduct.id,0), masterorderdefinition.name, masterorder.id AS masterorderid, masterorderproduct.product_id AS productid, masterorderproduct.id AS masterorderproductid, masterorder.masterordertype, masterorder.name AS masterordername, masterorder.number, masterorder.deadline, masterorder.masterorderstate AS masterorderstatus, masterorderproduct.masterorderpositionstatus, masterorderproduct.masterorderquantity, ( SELECT sum(orders.plannedquantity) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorderproduct masterorderproduct_1 ON masterorderproduct_1.id = orders.masterorderproductcomponent_id WHERE masterorderproduct_1.product_id = orders.product_id and orders.masterorderproductcomponent_id = masterorderproduct.id ) AS cumulatedmasterorderquantity, ( SELECT sum(orders.donequantity) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorderproduct masterorderproduct_1 ON masterorderproduct_1.id = orders.masterorderproductcomponent_id WHERE masterorderproduct_1.product_id = orders.product_id and orders.masterorderproductcomponent_id = masterorderproduct.id ) AS producedorderquantity, masterorderproduct.comments, (masterorderproduct.masterorderquantity-(SELECT COALESCE(sum(orders.donequantity),0) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorderproduct masterorderproduct_1 ON masterorderproduct_1.id = orders.masterorderproductcomponent_id WHERE masterorderproduct_1.product_id = orders.product_id and orders.masterorderproductcomponent_id = masterorderproduct.id) ) AS lefttorelease, product.number AS productnumber, product.name AS productname, product.unit, technology.number AS technologyname, company.name AS companyname, masterorder.active FROM masterorders_masterorder masterorder LEFT JOIN masterorders_masterorderproduct masterorderproduct ON masterorder.id = masterorderproduct.masterorder_id LEFT JOIN masterorders_masterorderdefinition masterorderdefinition ON masterorder.masterorderdefinition_id = masterorderdefinition.id LEFT JOIN basic_product product ON masterorderproduct.product_id = product.id LEFT JOIN basic_company company ON masterorder.company_id = company.id LEFT JOIN technologies_technology technology ON masterorderproduct.technology_id = technology.id WHERE masterorder.masterordertype = '03manyProducts' and masterorderproduct.id IS NOT NULL and (SELECT COALESCE(sum(orders.donequantity),0) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorderproduct masterorderproduct_1 ON masterorderproduct_1.id = orders.masterorderproductcomponent_id WHERE masterorderproduct_1.product_id = orders.product_id and orders.masterorderproductcomponent_id = masterorderproduct.id) < masterorderproduct.masterorderquantity UNION ALL SELECT COALESCE(masterorderproduct.id,0), masterorderdefinition.name, masterorder.id AS masterorderid, masterorderproduct.product_id AS productid, masterorderproduct.id AS masterorderproductid, masterorder.masterordertype, masterorder.name AS masterordername, masterorder.number, masterorder.deadline, masterorder.masterorderstate AS masterorderstatus, masterorderproduct.masterorderpositionstatus, masterorderproduct.masterorderquantity, ( SELECT sum(orders.plannedquantity) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorderproduct masterorderproduct_1 ON masterorderproduct_1.id = orders.masterorderproductcomponent_id WHERE masterorderproduct_1.product_id = orders.product_id and orders.masterorderproductcomponent_id = masterorderproduct.id ) AS cumulatedmasterorderquantity, ( SELECT sum(orders.donequantity) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorderproduct masterorderproduct_1 ON masterorderproduct_1.id = orders.masterorderproductcomponent_id WHERE masterorderproduct_1.product_id = orders.product_id and orders.masterorderproductcomponent_id = masterorderproduct.id ) AS producedorderquantity, masterorderproduct.comments, 0 AS lefttorelease, product.number AS productnumber, product.name AS productname, product.unit, technology.number AS technologyname, company.name AS companyname, masterorder.active FROM masterorders_masterorder masterorder LEFT JOIN masterorders_masterorderproduct masterorderproduct ON masterorder.id = masterorderproduct.masterorder_id LEFT JOIN masterorders_masterorderdefinition masterorderdefinition ON masterorder.masterorderdefinition_id = masterorderdefinition.id LEFT JOIN basic_product product ON masterorderproduct.product_id = product.id LEFT JOIN basic_company company ON masterorder.company_id = company.id LEFT JOIN technologies_technology technology ON masterorderproduct.technology_id = technology.id WHERE masterorder.masterordertype = '03manyProducts' and masterorderproduct.id IS NOT NULL and (SELECT COALESCE(sum(orders.donequantity),0) AS sum FROM orders_order orders LEFT JOIN masterorders_masterorderproduct masterorderproduct_1 ON masterorderproduct_1.id = orders.masterorderproductcomponent_id WHERE masterorderproduct_1.product_id = orders.product_id and orders.masterorderproductcomponent_id = masterorderproduct.id) >= masterorderproduct.masterorderquantity;
-- end
